...
from utils import coordinate2index, normalize_coordinate, normalize_3d_coordinate, map2local
from network.convonet.ResnetBlockFC import ResnetBlockFC
from network.convonet.unet import UNet
from network.convonet.unet3d import UNet3D
...
class LocalPoolPointnet(nn.Module):
    ...
    Args:
        ...
        plane_type (str or list): feature type, 'xz' - 1-plane, ['xz', 'xy', 'yz'] - 3-plane, ['grid'] - 3D grid volume
